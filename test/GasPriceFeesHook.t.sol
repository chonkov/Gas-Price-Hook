...
contract TestGasPriceFeesHook is Test, Deployers {
    ...
    function test_feeUpdatesWithGasPrice() public {
        ...
        // Current gas price is 100 gwei
        // Moving average should also be 100
        ...
        assertEq(movingAverageGasPrice, 100 gwei);
        ...
        // 1. Conduct a swap at gasprice = 100 gwei
        ...
        // 2. Conduct a swap at lower gasprice = 70 gwei
        ...
        // Our moving average should now be (100 + 100 + 70) / 3 = 90 Gwei
        movingAverageGasPrice = hook.movingAverageGasPrice();
        movingAverageGasPriceCount = hook.movingAverageGasPriceCount();
        assertEq(movingAverageGasPrice, 90 gwei);
        ...
        // 3. Conduct a swap at higher gas price = 150 gwei
        ...
        // Our moving average should now be (100 + 100 + 70 + 150) / 4 = 105 Gwei
        movingAverageGasPrice = hook.movingAverageGasPrice();
        movingAverageGasPriceCount = hook.movingAverageGasPriceCount();

        assertEq(movingAverageGasPrice, 105 gwei);
